...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="customerOrderList.php"><i class="fas fa-shopping-cart"></i>
                                Orders</a>
    ...
    <div class="container">
        <div class="col-md-8">
            ...
            $sql = "SELECT * FROM orderpreview WHERE username = '$_SESSION[User]'";
            ...
            if ($result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                ...
                echo "<tr><td>" . $count . "</td><td>" . $row['product_title'] . "</td> 
                <td>". $row['amount'] ."</td><td> $ ".$totalprice."</td></tr>";
                $count+=1;
              }
              echo "</table>";
            } else {

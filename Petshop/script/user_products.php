    ...
    <nav class="navbar navbar-expand-lg sticky-top navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="customerOrderList.php"><i class="fas fa-shopping-cart"></i> Orders</a>
...
<div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-5">
        ...
        ?>
      <form method='post' action='orderItem1.php'>
      Amount :  <input type='number' min = "1" max = "999" size='1' name='item' value="1"/>
       <br><br>
    ...
    <div class="row">
        ...
        ?>
      <form method='post' action='orderItem2.php'>
      Amount :  <input type='number' min = "1" max = "999" size='1' name='item' value="1"/>
       <br><br>
       <button type="submit" class="btn btn-primary">
          Buy
    ...
    <div class="row">
        ...
        ?>
        <form method='post' action='orderItem3.php'>
        Amount :  <input type='number' min = "1" max = "999" size='1' name='item' value="1"/>
        <br><br>
        <button type="submit" class="btn btn-primary">
            Buy
    ...
    <div class="row">
        ...
        ?>
        <form method='post' action='orderItem4.php'>
        Amount :  <input type='number' min = "1" max = "999" size='1' name='item' value="1"/>
       <br><br>
       <button type="submit" class="btn btn-primary">
          Buy

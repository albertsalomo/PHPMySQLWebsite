...
$key = $_POST['confirmBtn'];
$sql = "DELETE FROM transaction WHERE order_id=$key";
if ($conn->query($sql) === TRUE) {
    ?>
    <div class="updatetxt">
    <?php
  echo "Order number '$key' has been confirmed";
  ?>
  </div>
  <br>
    <a class="btn btn-primary" href="adminOrderViewer.php" role="button">< Back</a>
  <?php
